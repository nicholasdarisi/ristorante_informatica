...
public class Grafica_tavoli {
	...
	public Grafica_tavoli() {
		...
		frmTavoli.setBounds(100, 100, 1150, 670);
		...
		scrollPaneTavoli.setBounds(12, 76, 217, 543);
		...
		frmTavoli.getContentPane().add(txtInfo);
		...
		frmTavoli.getContentPane().add(textField);
		...
		frmTavoli.getContentPane().add(textField_4);
		...
		frmTavoli.getContentPane().add(textField_17);
		...
		frmTavoli.getContentPane().add(textField_14);
		...
		frmTavoli.getContentPane().add(textField_3);
		...
		frmTavoli.getContentPane().add(textField_5);
		...
		frmTavoli.getContentPane().add(textField_8);
		...
		frmTavoli.getContentPane().add(textField_9);
		...
		frmTavoli.getContentPane().add(textField_10);
		...
		frmTavoli.getContentPane().add(textField_15);
		...
		frmTavoli.getContentPane().add(textField_18);
		...
		frmTavoli.getContentPane().add(textField_11);
		...
		frmTavoli.getContentPane().add(textField_2);
		...
		frmTavoli.getContentPane().add(textField_1);
		...
		frmTavoli.getContentPane().add(textField_13);
		...
		frmTavoli.getContentPane().add(textField_6);
		...
		frmTavoli.getContentPane().add(textField_12);
		...
		frmTavoli.getContentPane().add(textField_16);
		...
		frmTavoli.getContentPane().add(textField_7);
		...
		frmTavoli.getContentPane().add(textField0);
		...
		frmTavoli.getContentPane().add(textField1);
		...
		frmTavoli.getContentPane().add(textField2);
		...
		frmTavoli.getContentPane().add(textField3);
		...
		frmTavoli.getContentPane().add(textField4);
		...
		frmTavoli.getContentPane().add(textField5);
		...
		frmTavoli.getContentPane().add(textField6);
		...
		frmTavoli.getContentPane().add(textField7);
		...
		frmTavoli.getContentPane().add(textField8);
		...
		frmTavoli.getContentPane().add(textField9);
		...
		frmTavoli.getContentPane().add(textField10);
		...
		frmTavoli.getContentPane().add(textField11);
		...
		frmTavoli.getContentPane().add(textField12);
		
		lblSfondo = new JLabel("");
		lblSfondo.setIcon(new ImageIcon(Grafica_tavoli.class.getResource("/Img/cassa.png")));
